package com.sciapps.yaeln.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    public Mono<ResponseEntity<Problem>> handleEmailAlreadyUsedException(com.sciapps.yaeln.service.EmailAlreadyUsedException ex, ServerWebExchange request) {
    ...
    @ExceptionHandler
    public Mono<ResponseEntity<Problem>> handleUsernameAlreadyUsedException(com.sciapps.yaeln.service.UsernameAlreadyUsedException ex, ServerWebExchange request) {
        LoginAlreadyUsedException problem = new LoginAlreadyUsedException();
        return create(problem, request, HeaderUtil.createFailureAlert(applicationName,  true, problem.getEntityName(), problem.getErrorKey(), problem.getMessage()));
    }

    @ExceptionHandler
    public Mono<ResponseEntity<Problem>> handleInvalidPasswordException(com.sciapps.yaeln.service.InvalidPasswordException ex, ServerWebExchange request) {
